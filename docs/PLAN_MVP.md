...
Plan de tareas — pendiente de definir a partir de `docs/Requerimientos_<app>.md` (el spec de negocio de factura-electronica.app todavía no existe en `docs/`; es el bloqueo actual para proponer la siguiente tarea de feature — ver `docs/PROGRESO.md`).
