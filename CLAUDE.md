...
1. **Multi-tenant:** toda tabla de datos de tenant lleva `tenant_id NOT NULL` + política RLS. El subdominio define el tenant; JAMÁS aceptar `tenant_id` desde el cliente.
